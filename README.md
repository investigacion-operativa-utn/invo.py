...
| - | - | -  | -  |
| | | :rocket: ***CLASE 01*** | |
| Simulación | :black_circle:T | Introducción a Simulación | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/simulacion/teoria/TEO_intro-simulacion-metodos-sampleo.pdf) |
| Simulación | :black_circle:T | Ajuste paramétrico de distribuciones | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/simulacion/teoria/TEO_ajuste_parametrico_distribuciones/seminario_max_like.pdf) [![Notebook](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/investigacion-operativa-utn/invo.py/blob/main/simulacion/teoria/TEO_ajuste_parametrico_distribuciones/exponential_fit.ipynb) |
| Simulación | :large_blue_circle:P | Introducción a métodos de sampleo en simulación | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/simulacion/teoria/TEO_simulacion-exponencial) |
...
| - | - | -  | -  |
| | | :rocket: ***CLASE 02*** | |
| Simulación | :black_circle:T | Simulación con distribución exponencial | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/simulacion/teoria/TEO_simulacion-exponencial) |
...
| Simulación | :large_blue_circle:P | Ejercicio 04 | [![Notebook](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/investigacion-operativa-utn/invo.py/blob/main/simulacion/practica/PRA_ejercicio-simulacion-04.ipynb) |
| - | - | -  | -  |
| | | :rocket: ***CLASE 03*** | |
| Markov | :black_circle:T | Introducción a Cadenas de Markov | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/markov/teoria/TEO_intro-markov-discreto.pdf) |
...
| - | - | -  | -  |
| | | :rocket: ***CLASE 04*** | |
| Markov | :black_circle:T | Cadenas de Markov | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/markov/teoria/TEO_calculo-markov-discreto.pdf) |
...
| - | - | -  | -  |
| | | :rocket: ***CLASE 05*** | |
| Markov | :black_circle:T | Cadenas de Markov de parámetro continuo | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/markov/teoria/TEO_markov-continuo.pdf) |
...
| - | - | -  | -  |
| | | :rocket: ***CLASE 06*** | |
| Filas | :black_circle:T | Procesos de Nacimiento y Muerte, Filas de Espera M=1 | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/filas_de_espera/teoria/TEO_intro-filas-de-espera.pdf) |
| Filas | :large_blue_circle:P | Ejercicio 01 | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/filas_de_espera/practica/ejercicio_filas_01_prez.pdf) |
...
| - | - | -  | -  |
| | | :rocket: ***CLASE 08*** | |
| Filas | :black_circle:T | Análisis de sensibilidad en filas de espera | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/filas_de_espera/teoria/TEO_filas-de-espera-analisis-sensibilidad.pdf) |
...
| Proyectos | :large_blue_circle:P | Ejercicio 01 | [![PDF - Slides](https://img.shields.io/badge/PDF-Slides-c13637?logo=google&logoColor=ffffff)](https://github.com/investigacion-operativa-utn/invo.py/blob/main/proyectos/practica/PRA_ejercicio-proyectos-02/ejercicio_2.pdf) |
